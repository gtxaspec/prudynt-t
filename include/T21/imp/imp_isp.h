...
/**
 * @fn int IMP_ISP_Tuning_SetDRC_Strength(unsigned int strength)
 *
 * 设置DRC强度值.
 *
 ...
 * @attention 在使用这个函数之前，IMP_ISP_EnableTuning已被调用。
 */
int IMP_ISP_Tuning_SetDRC_Strength(unsigned int strength);

/**
 * @fn int IMP_ISP_Tuning_GetDRC_Strength(unsigned int *strength)
 *
 * 获取DRC强度值.
 *
 ...
 * @attention 在使用这个函数之前，IMP_ISP_EnableTuning已被调用。
 */
int IMP_ISP_Tuning_GetDRC_Strength(unsigned int *strength);
