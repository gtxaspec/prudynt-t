 ...
 * @remarks none.
 *
 * @attention AiGain ranges from [0,255]. If the input value is less than 0, the value of aiGain will be set to 0. If the value is greater than 255,aiGain is set to 255.aiGain range:[0 ~ 255].
 */
