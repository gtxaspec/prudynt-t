...
typedef struct stRgnCreateStat{
    int status;                         /**< The osd region creation status,0:not creat; 1:region is create */
}IMPOSDRgnCreateStat;
 ...
 * @retval non-0 failure
 *
 * @remark Calling this API requires that the corresponding group has been created.
 *
 * @attention none
 */
 ...
 * @retval non-0 failure
 *
 * @remark In the latest SDK version, it is recommended to Attach the OSD node to the system data flow. \n
 * However, attaching the OSD node is not recommended is API reserved, convenient compatibility with previous versions of the software. \n
 ...
 * @retval non-0 failure
 *
 * @remark To invoke this API, ensure that the OSD group has been created.
 *
 * @attention none
 */
 ...
 * @retval non-0 failure
 *
 * @remark To invoke this API, ensure that the OSD group has been created and the corresponding region has been registered.
 *
 * @attention none
 */
 ...
 * @retval non-0 failure
 *
 * @remark Calling this API requires that the corresponding region has been created.
 *
 * @attention none
 */
 ...
 * @retval non-0 failure
 *
 * @remark To call this API, the corresponding region must have been created and the region property has been set to OSD_REG_BITMAP or OSD_REG_PIC.
 *
 * @attention none
 */
 ...
 * @retval non-0 failure
 *
 * @remark To invoke this API, ensure that the OSD group has been created and the region has been created and registered.
 *
 * @attention none
 */
...
/**
 * @fn int IMP_OSD_SetRgnAttr_ISP(IMPOSDRgnAttr *prAttr,int bosdshow);
 *
 * Set the interface for an ISP to draw OSD attributes
 *
 * @param[in]prAttr OSD Area Attributes，bosdshow Switch the OSD flag. This flag is 0, indicating that only ISPosd can be drawn.If the value is 1, both ISPosd, IPU, DBox, and OSD can be drawn.
 *
 * @retval 0 success
 * @retval non-0 failure
 *
 * @remark Calling this API requires that IMP_ISP_EnableTuning has been invoked
 * @remark This interface supports only the OSD_REG_ISP_PIC and OSD_REG_ISP_LINE_RECT types
 *
 * @attention none
 */
...
/**
 * @fn int IMP_OSD_GetRgnAttr_ISP(IMPOSDRgnAttr *prAttr,int *pbosdshow);
 *
 * Obtain the interface used by the ISP to draw OSD attributes
 *
 * @param[in]Pbosdshow can get THE OSD flag of ISP switch\
 *
 * @retval 0 success
 * @retval non-0 failure
 *
