 ...
 * @remarks 最多分配2块内存空间用于缓存用户数据,且每段用户数据大小不超过1k byte。
 ...
 *
 * @remarks 如果通道未创建,则返回失败
 * @remarks 此API只适用于H265
 * @remarks 建议在创建编码channel之后，startRecvPic之前调用, 设置时先GetH265TransCfg，然后再SetH265TransCfg
 *
 * @attention 无
 */
