...
Config::Config() {
    ...
    std::vector<ConfigItem<int>> intItems = {
        ...
        {"stream0.osd_pos_x", stream0osdPosX, 5, [](const int &v) { return true; }, ""},
        {"stream0.osd_pos_y", stream0osdPosY, 5, [](const int &v) { return true; }, ""},
        {"stream0.osd_user_text_pos_x", stream0osdUserTextPosX, 900, [](const int &v) { return true; }, ""},
        {"stream0.osd_user_text_pos_y", stream0osdUserTextPosY, 5, [](const int &v) { return true; }, ""},
        {"stream0.osd_uptime_stamp_pos_x", stream0osdUptimeStampPosX, 1600, [](const int &v) { return true; }, ""},
        {"stream0.osd_uptime_stamp_pos_y", stream0osdUptimeStampPosY, 5, [](const int &v) { return true; }, ""},
        {"stream0.osd_logo_pos_x", stream0osdLogoPosX, 1800, [](const int &v) { return true; }, ""},
        {"stream0.osd_logo_pos_y", stream0osdLogoPosY, 1030, [](const int &v) { return true; }, ""},
