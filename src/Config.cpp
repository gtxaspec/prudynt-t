...
std::vector<ConfigItem<int>> CFG::getIntItems()
{
    return {
        ...
        {"stream0.osd.font_xscale", stream0.osd.font_xscale, OSD_AUTO_VALUE, validateIntGe0},
        {"stream0.osd.font_yscale", stream0.osd.font_yscale, OSD_AUTO_VALUE, validateIntGe0},
        {"stream0.osd.font_yoffset", stream0.osd.font_yoffset, 4, validateIntGe0},
        ...
        {"stream1.osd.font_xscale", stream1.osd.font_xscale, OSD_AUTO_VALUE, validateIntGe0},
        {"stream1.osd.font_yscale", stream1.osd.font_yscale, OSD_AUTO_VALUE, validateIntGe0},
        {"stream1.osd.font_yoffset", stream1.osd.font_yoffset, 4, validateIntGe0},
